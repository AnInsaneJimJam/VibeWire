...
export default function Hangouts() {
  ...
  // Mock connections data (same as in profile.tsx)
  ...
  const [hangouts, setHangouts] = useState<Hangout[]>([
    {
      ...
      participants: [connections[0], connections[1]],
      maxParticipants: 4,
      createdBy: "USR123456",
      hostName: "You",
      status: "upcoming",
      description: "Group study session for upcoming Data Structures exam. Bring your notes!",
      pendingRequests: [connections[2]], // Add pending requests array
    },
    {
      id: "2",
      ...
      date: "2024-01-22",
      time: "7:00 PM",
      venue: "Rajiv Bhawan Common Room",
      participants: [connections[0], connections[2], connections[3]],
      maxParticipants: 6,
      createdBy: "USR789012",
      hostName: "Arpit Agarwal",
      status: "ongoing",
      description: "Marvel movie marathon! Snacks will be provided.",
      pendingRequests: [],
    },
    {
      id: "3",
      ...
      time: "4:00 PM",
      venue: "Sports Ground",
      participants: [connections[1], connections[2]],
      maxParticipants: 8,
      createdBy: "USR789012",
      hostName: "Priya Patel",
      status: "completed",
      description: "Friendly cricket match between bhawans.",
      pendingRequests: [],
    },
    {
      id: "4",
